...
<div id="header">
  ...
  <tr>
    ...
    <td width="894" align="center"><a href="trangchu.php"><img src="image/logo6.png"></a>&nbsp;</td>
    </div></td>
...
<div style="width:1200px; height:600px; background-color:#CCC;padding:30px;margin:0 auto; text-align:center;
...
$id= $_GET["id"];
$stm = $pdh->prepare("select * from giay where magiay='$id'");
$stm->execute(); 
...
{ 	
    ...
    <div class=sp>
        ...
        Tên Giày: <?php echo $row["tengiay"]?><br />
        Giá: <?php echo $row["gia"]?>VND<br />
		Thuộc Tính: <?php echo $row["thuoctinh"]?><br />
        <img src="image/giay/<?php echo $row["img"];?>" width="500px" height="400px" /><br />
 </div>
<?php
}
?>
</div>
</div><div id="footer"> Copyright © 2015 Trường Đại Học Công Nghệ Sài Gòn | Designed by: PHAN HOÀNG NAM - LÊ VIỆT NHỰT
</div>
</body>
</html>
