...
$stm = $pdh->prepare("select * from giay where thuoctinh='Nam'");
$stm->execute();
$rows = $stm->fetchAll(PDO::FETCH_ASSOC);
?>
<h1 style="font-weight:bold; font-size:25px">Giày Nam </h1><br/>
<?php
$i=0;
foreach($rows as $row)
{ $i++;
	?>
    <div class=sp>
       <img src="image/giay/<?php echo $row["img"];?>" width="380px" height="300px" /><br />
       <div id="magiay" <h3><a href="chitietsanpham.php?id=<?php echo $row["magiay"];?>"><?php echo $row["tengiay"]?><br /></a> 
       </div>     
